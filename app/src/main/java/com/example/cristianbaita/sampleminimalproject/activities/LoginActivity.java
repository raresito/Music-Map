...
public class LoginActivity extends AppCompatActivity {
    ...
    private AppCompatActivity herecontext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingDummyData();
        adapter = new CoverFlowAdapter(LoginActivity.this, games);
    ...
    private void displayInfoDialogView() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(InstagramLogin.this);
        ...
        new ImageLoader(InstagramLogin.this).DisplayImage(userInfoHashmap.get(InstagramApp.TAG_PROFILE_PICTURE), ivProfile);
